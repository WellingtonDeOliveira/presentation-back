...
@Operation(
        ...
        description = "Requires role: " + RoleType.Roles.ROLE_GET_PRESENTATION
)
@PreAuthorize("hasAnyRole(T(br.com.base.shared.models.enums.RoleType).ROLE_GET_PRESENTATION)")
