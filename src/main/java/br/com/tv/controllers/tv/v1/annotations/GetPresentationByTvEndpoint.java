...
@Operation(
        summary = "Get Presentation by TV",
        description = "Requires role: " + RoleType.Roles.ROLE_GET_PRESENTATION_BY_TV
)
@PreAuthorize("hasAnyRole(T(br.com.base.shared.models.enums.RoleType).ROLE_GET_PRESENTATION_BY_TV)")
@RequestMapping(method = RequestMethod.GET, path = "/view", produces = "application/json")
@OpenApiResponse200
@OpenApiResponse400
@OpenApiResponse401
@OpenApiResponse403
...
public @interface GetPresentationByTvEndpoint {
}
