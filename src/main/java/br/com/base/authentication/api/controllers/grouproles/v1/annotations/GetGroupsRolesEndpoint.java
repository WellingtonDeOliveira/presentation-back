...
@Operation(
        ...
        description = "Requires role: " + RoleType.Roles.ROLE_GET_GROUPS_ROLES
)
@PreAuthorize("hasAnyRole(T(br.com.base.shared.models.enums.RoleType).ROLE_GET_GROUPS_ROLES)")
...
public @interface GetGroupsRolesEndpoint {
}
